...
public class SpellCorrect {
  ...
  public SpellCorrect() {
    HolbrookCorpus corpus = new HolbrookCorpus("pa2-autocorrect-v1/data/holbrook-tagged-train.dat");
    editModel = new EditModel("pa2-autocorrect-v1/data/count_1edit.txt", corpus);
    languageModel = null;
  }
